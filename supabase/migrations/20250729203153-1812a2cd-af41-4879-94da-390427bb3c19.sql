-- Add comprehensive datacenter component library to database (with correct skill levels)
...
('ups-three-phase-40kva', 'UPS - Three Phase 40kVA', 'Electrical Infrastructure', 'Three-phase UPS system for critical power protection', 'each', 16, 'specialist', '{"preferred_vendor": "Eaton", "part_number": "9PX40K", "contact_info": "eaton.com"}', 42, '{"power_rating": "40kVA/36kW", "voltage": "480V/208V", "runtime": "10 minutes at full load", "dimensions": "78\" H x 24\" W x 32\" D", "weight": "850 lbs", "efficiency": "96%"}', 0.03, 'Professional installation required, includes battery cabinet'),

('crac-unit-20-ton', 'CRAC Unit - 20 Ton', 'Mechanical Systems', 'Computer Room Air Conditioning unit for precision cooling', 'each', 24, 'specialist', '{"preferred_vendor": "Liebert", "part_number": "DS020", "contact_info": "vertiv.com"}', 56, '{"cooling_capacity": "20 tons", "power_consumption": "18kW", "airflow": "6800 CFM", "dimensions": "84\" H x 30\" W x 30\" D", "weight": "950 lbs", "refrigerant": "R410A"}', 0.05, 'Requires refrigerant lines, condensate drain, and electrical connections'),

('crac-unit-40-ton', 'CRAC Unit - 40 Ton', 'Mechanical Systems', 'High-capacity CRAC unit for large data centers', 'each', 32, 'specialist', '{"preferred_vendor": "Liebert", "part_number": "DS040", "contact_info": "vertiv.com"}', 56, '{"cooling_capacity": "40 tons", "power_consumption": "35kW", "airflow": "13600 CFM", "dimensions": "84\" H x 48\" W x 30\" D", "weight": "1600 lbs", "refrigerant": "R410A"}', 0.05, 'Requires crane for installation, refrigerant lines, and dedicated electrical'),
...
('server-1u-entry', '1U Server - Entry Level', 'IT Infrastructure', 'Entry-level 1U rack server for basic computing needs', 'each', 1, 'entry', '{"preferred_vendor": "Dell", "part_number": "PowerEdge R230", "contact_info": "dell.com"}', 21, '{"form_factor": "1U", "cpu": "Intel Xeon E3", "memory": "8GB DDR4", "storage": "1TB SATA", "power": "250W", "network": "2x 1GbE"}', 0.02, 'Basic rack installation, standard power and network connections'),
...
('raised-floor-24x24', 'Raised Floor Panel 24"x24"', 'Structural Systems', 'Standard raised floor panel for data center flooring', 'sq_ft', 0.25, 'entry', '{"preferred_vendor": "Tate", "part_number": "ConCore", "contact_info": "tateaccessfloors.com"}', 21, '{"size": "24\" x 24\"", "thickness": "1.5\"", "load_rating": "1250 lbs", "material": "Steel with concrete core"}', 0.05, 'Requires pedestal grid system and proper leveling'),
