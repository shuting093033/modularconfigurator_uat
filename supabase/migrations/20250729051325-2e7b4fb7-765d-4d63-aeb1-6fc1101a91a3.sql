-- Phase 1: Database Schema Enhancement for Data Center Construction Cost Management

-- Enhanced Components table with technical specifications
ALTER TABLE public.components 
ADD COLUMN labor_hours DECIMAL(10,2),
ADD COLUMN skill_level TEXT CHECK (skill_level IN ('entry', 'intermediate', 'expert', 'specialist')),
ADD COLUMN vendor_info JSONB,
ADD COLUMN lead_time_days INTEGER,
ADD COLUMN technical_specs JSONB,
ADD COLUMN material_waste_factor DECIMAL(5,4) DEFAULT 0.05,
...
-- Create RLS policies for Categories (publicly readable, admin-only write)
